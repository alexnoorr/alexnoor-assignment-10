...
app = Flask(__name__)
file_prefix =  "/Users/alexnoor/Desktop/coco_images_resized/"

@app.route("/images/<path:filename>")
def custom_image(filename):
    return send_from_directory(file_prefix, filename)
# Load images and embeddings
image_dir = "/Users/alexnoor/Desktop/coco_images_resized"  # Update this to your folder path
...
df = pd.read_pickle("/Users/alexnoor/Desktop/image_embeddings.pickle")
